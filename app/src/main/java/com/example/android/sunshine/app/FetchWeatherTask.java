...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String getReadableDateString(long time){
        ...
        return new SimpleDateFormat("E, MMM d", Locale.US).format(date);
    }
    ...
    /*
        ...
        the database.
     */
    String[] convertContentValuesToUXFormat(Vector<ContentValues> cvv, String unitType) {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                mContext.getApplicationContext().getContentResolver().bulkInsert(
...
//            }
            ...
            String[] resultStrs = convertContentValuesToUXFormat(cVVector, unitType);
            return resultStrs;
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            return getWeatherDataFromJson(forecastJsonStr, locationQuery, params[1]);
        } catch (JSONException e) {
            Log.e(LOG_TAG, e.getMessage(), e);
            e.printStackTrace();
        }
